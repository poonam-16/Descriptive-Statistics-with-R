...
x = matrix(nrow = 4,3,data = c(2,14,8,3,9,10,5,7,8,25,11,6)) #Creates matrix with 4 rows & 3 columns
x

#By default values are filled column wise, to change we use byrow function
x = matrix(nrow = 4,3,data = c(2,14,8,3,9,10,5,7,8,25,11,6), byrow = TRUE)
x
